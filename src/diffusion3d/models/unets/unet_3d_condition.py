...
from ...loaders.unet import UNet3DConditionLoadersMixin
...
class UNet3DConditionModel(ModelMixin, ConfigMixin, UNet3DConditionLoadersMixin, PeftAdapterMixin):
    r"""
    ...
    Parameters:
        sample_size (`int` or `Tuple[int, int, int]`, *optional*, defaults to `None`):
            Depth, height and width of input/output sample.
        ...
        mid_block_type (`str`, *optional*, defaults to `"UNetMidBlock3DCrossAttn"`):
            Block type for middle of UNet, it can be one of `UNetMidBlock3DCrossAttn`, `UNetMidBlock3D`, or
            `UNetMidBlock3DSimpleCrossAttn`. If `None`, the mid block layer is skipped.
        up_block_types (`Tuple[str]`, *optional*, defaults to `("UpBlock3D", "CrossAttnUpBlock3D", "CrossAttnUpBlock3D")`):
        ...
        transformer_layers_per_block (`int`, `Tuple[int]`, or `Tuple[Tuple]` , *optional*, defaults to 1):
            ...
            [`~models.unets.unet_3d_blocks.CrossAttnDownBlock3D`], [`~models.unets.unet_3d_blocks.CrossAttnUpBlock3D`],
            [`~models.unets.unet_3d_blocks.UNetMidBlock3DCrossAttn`].
        ...
        resnet_time_scale_shift (`str`, *optional*, defaults to `"default"`): Time scale shift config
            for ResNet blocks (see [`~models.resnet.ResnetBlock3D`]). Choose from `default` or `scale_shift`.
        ...
        *optional*): The dimension of the `class_labels` input when
        ...
        mid_block_only_cross_attention (`bool`, *optional*, defaults to `None`):
            Whether to use cross attention with the mid block when using the `UNetMidBlock3DSimpleCrossAttn`. If
    ...
    def forward(
        ...
        for downsample_block in self.down_blocks:
            if hasattr(downsample_block, "has_cross_attention") and downsample_block.has_cross_attention:
                # For t2i-adapter CrossAttnDownBlock3D
